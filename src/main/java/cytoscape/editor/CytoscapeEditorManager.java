...
public abstract class CytoscapeEditorManager {
	...
	public static final String ANNOTATION_TEXT_TYPE = "ANNOTATION_TEXT_TYPE";	
	
	public static final String ANNOTATION_SHAPE_TYPE = "ANNOTATION_SHAPE_TYPE";	
	
	public static final String ANNOTATION_BOUNDED_TYPE = "ANNOTATION_BOUNDED_TYPE";	
	
	public static final String ANNOTATION_IMAGE_TYPE = "ANNOTATION_IMAGE_TYPE";	
...
//	public static final String EDGE_TYPE = "EDGE_TYPE";
	...
	public static void register(String editorName) {
		register(editorName, "BasicNetworkEventHandler", CytoscapeEditorManager.NODE_TYPE,
		         CytoscapeEditorManager.EDGE_TYPE, CytoscapeEditorManager.NETWORK_TYPE, CytoscapeEditorManager.ANNOTATION_TEXT_TYPE, CytoscapeEditorManager.ANNOTATION_SHAPE_TYPE, CytoscapeEditorManager.ANNOTATION_BOUNDED_TYPE, CytoscapeEditorManager.ANNOTATION_IMAGE_TYPE, CytoscapeEditorManager.ANY_VISUAL_STYLE);
	}
	 ...
	 */
	public static void register(String editorName, String networkEditAdapterName,
	                            String controllingNodeAttribute, String controllingEdgeAttribute, String controllingNetworkAttribute, String controllingTextAnnotationAttribute, String controllingShapeAnnotationAttribute, String controllingBoundedAnnotationAttribute, String controllingImageAnnotationAttribute,
	                            String visualStyleName) {
		...
		if (cyEditor != null) {
			...
			cyEditor.setControllingTextAnnotationAttribute(controllingTextAnnotationAttribute);
			cyEditor.setControllingShapeAnnotationAttribute(controllingShapeAnnotationAttribute);
			cyEditor.setControllingBoundedAnnotationAttribute(controllingBoundedAnnotationAttribute);
			cyEditor.setControllingImageAnnotationAttribute(controllingImageAnnotationAttribute);			
