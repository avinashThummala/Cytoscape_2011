	...
	*/
	...
	public BasicCytoShapeEntity(String attributeName, String attributeValue, Icon image,
		...
		if (this.attributeName != null) {
			...
			} else if (this.attributeName.equals("ANNOTATION_TEXT_TYPE")) {				
				_cytoShape.setToolTipText("<html>To add a Text annotation to a<br>"
                        + "network, drag and drop this palette<br>"
					      + "onto the canvas<br>");				
			}else if (this.attributeName.equals("ANNOTATION_SHAPE_TYPE")) {				
				_cytoShape.setToolTipText("<html>To add a Shape annotation to a<br>"
                        + "network, drag and drop this palette<br>"
					      + "onto the canvas<br>");
			}else if (this.attributeName.equals("ANNOTATION_BOUNDED_TYPE")) {				
				_cytoShape.setToolTipText("<html>To add a Bounded annotation to a<br>"
                        + "network, drag and drop this palette<br>"
					      + "onto the canvas<br>");
			}else if (this.attributeName.equals("ANNOTATION_IMAGE_TYPE")) {				
				_cytoShape.setToolTipText("<html>To add an Image annotation to a<br>"
                        + "network, drag and drop this palette<br>"
					      + "onto the canvas<br>");
			}
