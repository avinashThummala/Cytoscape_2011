...
public interface CytoscapeEditor extends SelectEventListener {
	...
	*
	...
	public void setControllingTextAnnotationAttribute(String controllingNetworkAttribute);
	
	public String getControllingShapeAnnotationAttribute();
	
	public void setControllingShapeAnnotationAttribute(String controllingNetworkAttribute);	
	
	public String getControllingBoundedAnnotationAttribute();
	
	public void setControllingBoundedAnnotationAttribute(String controllingNetworkAttribute);
	
	public String getControllingImageAnnotationAttribute();
	
	public void setControllingImageAnnotationAttribute(String controllingNetworkAttribute);	
