...
public class PaletteNetworkEditEventHandler extends BasicNetworkEditEventHandler {
	...
	public void itemDropped(PhoebeCanvasDropEvent e) {
		...
		if (myShape != null) {
			...
			} else if (attributeName.equals(get_caller().getControllingTextAnnotationAttribute())){
											
				setTextAnnotationAttributeName(attributeName);
				setTextAnnotationAttributeValue(attributeValue);
				
				handleDroppedTextAnnotation(getTextAnnotationAttributeName(), getTextAnnotationAttributeValue(), location);
				
			} else if (attributeName.equals(get_caller().getControllingShapeAnnotationAttribute())){
											
				setTextAnnotationAttributeName(attributeName);
				setTextAnnotationAttributeValue(attributeValue);
				
				handleDroppedShapeAnnotation(getTextAnnotationAttributeName(), getTextAnnotationAttributeValue(), location);
				
			} else if (attributeName.equals(get_caller().getControllingBoundedAnnotationAttribute())){
											
				setTextAnnotationAttributeName(attributeName);
				setTextAnnotationAttributeValue(attributeValue);
				
				handleDroppedBoundedAnnotation(getTextAnnotationAttributeName(), getTextAnnotationAttributeValue(), location);
				
			} else if (attributeName.equals(get_caller().getControllingImageAnnotationAttribute())){
											
				setTextAnnotationAttributeName(attributeName);
				setTextAnnotationAttributeValue(attributeValue);
				
				handleDroppedImageAnnotation(getTextAnnotationAttributeName(), getTextAnnotationAttributeValue(), location);			
			}
			
		}
	}
	
	protected void handleDroppedTextAnnotation(String attributeName, String attributeValue, Point location) {

		get_caller().addTextAnnotation( attributeName, attributeValue, location);
	}		
	
	protected void handleDroppedShapeAnnotation(String attributeName, String attributeValue, Point location) {

		get_caller().addShapeAnnotation( attributeName, attributeValue, location);
	}
	
	protected void handleDroppedBoundedAnnotation(String attributeName, String attributeValue, Point location) {

		get_caller().addBoundedAnnotation( attributeName, attributeValue, location);
	}
	
	protected void handleDroppedImageAnnotation(String attributeName, String attributeValue, Point location) {

		get_caller().addImageAnnotation( attributeName, attributeValue, location);
	}		
