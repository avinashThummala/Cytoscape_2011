...
public class BasicNetworkEditEventHandler extends NetworkEditEventAdapter implements ActionListener, cytoscape.data.attr.MultiHashMapListener, PropertyChangeListener
{
	...
	protected String textAnnotationAttributeName = "ANNOTATION_TEXT_TYPE";	
	protected String textAnnotationAttributeValue = "TextAnnotation";	
	protected String shapeAnnotationAttributeName = "ANNOTATION_SHAPE_TYPE";	
	protected String shapeAnnotationAttributeValue = "ShapeAnnotation";	
	protected String boundedAnnotationAttributeName = "ANNOTATION_BOUNDED_TYPE";	
	protected String boundedAnnotationAttributeValue = "BoundedAnnotation";		
	protected String imageAnnotationAttributeName = "ANNOTATION_IMAGE_TYPE";	
	protected String imageAnnotationAttributeValue = "ImageAnnotation";	
	/*
	...
	*/
	...
	public String getTextAnnotationAttributeName() {
		return textAnnotationAttributeName;
	}

	public void setTextAnnotationAttributeName(String attributeName) {
		this.textAnnotationAttributeName = attributeName;
	}	
	
	public String getShapeAnnotationAttributeName() {
		return shapeAnnotationAttributeName;
	}

	public void setShapeAnnotationAttributeName(String attributeName) {
		this.shapeAnnotationAttributeName = attributeName;
	}	
	
	public String getBoundedAnnotationAttributeName() {
		return boundedAnnotationAttributeName;
	}

	public void setBoundedAnnotationAttributeName(String attributeName) {
		this.boundedAnnotationAttributeName = attributeName;
	}	
	
	public String getImageAnnotationAttributeName() {
		return imageAnnotationAttributeName;
	}

	public void setImageAnnotationAttributeName(String attributeName) {
		this.imageAnnotationAttributeName = attributeName;
	}
	
	public String getTextAnnotationAttributeValue() {
		return textAnnotationAttributeValue;
	}

	public void setTextAnnotationAttributeValue(String attributeValue) {
		this.textAnnotationAttributeValue = attributeValue;
	}	
	
	public String getShapeAnnotationAttributeValue() {
		return shapeAnnotationAttributeValue;
	}

	public void setShapeAnnotationAttributeValue(String attributeValue) {
		this.shapeAnnotationAttributeValue = attributeValue;
	}	
	
	public String getBoundedAnnotationAttributeValue() {
		return boundedAnnotationAttributeValue;
	}

	public void setBoundedAnnotationAttributeValue(String attributeValue) {
		this.boundedAnnotationAttributeValue = attributeValue;
	}	
	
	public String getImageAnnotationAttributeValue() {
		return imageAnnotationAttributeValue;
	}

	public void setImageAnnotationAttributeValue(String attributeValue) {
		this.imageAnnotationAttributeValue = attributeValue;
	}	
