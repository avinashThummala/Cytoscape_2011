...
import cytoscape.editor.neo4j.neoPlugin;
...
public class CytoscapeEditorPlugin extends CytoscapePlugin {
	...
	public CytoscapeEditorPlugin() {
		...
		//Trying to create a Plugin that reads from a Neo4j database
		
		//neoPlugin neo4j=new neoPlugin();
	...
	// public static void initializeCytoscapeEditor() {
		...
		// style
		CytoscapeEditorManager.NODE_TYPE, CytoscapeEditorManager.EDGE_TYPE, CytoscapeEditorManager.NETWORK_TYPE, CytoscapeEditorManager.ANNOTATION_TEXT_TYPE, CytoscapeEditorManager.ANNOTATION_SHAPE_TYPE, CytoscapeEditorManager.ANNOTATION_BOUNDED_TYPE, CytoscapeEditorManager.ANNOTATION_IMAGE_TYPE,   
