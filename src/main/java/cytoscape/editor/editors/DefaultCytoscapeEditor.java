...
public class DefaultCytoscapeEditor extends BasicCytoscapeEditor implements ChangeListener {
	...
	protected void generatePaletteEntries() {
		...
		generateAnnotationPaletteEntries();
	}
	
	protected void generateAnnotationPaletteEntries() {
	
		javax.swing.ImageIcon icon = new ImageIcon(getClass().getResource("/ImageAnnotationIcon.png"));
				
		shapePalette.addShape(getControllingTextAnnotationAttribute(), "TextAnnotation",
			                     new CytoShapeIcon(1),								
								"Add a Text Annotation",
								null);	
		
		shapePalette.addShape(getControllingShapeAnnotationAttribute(), "TextAnnotation",
                new CytoShapeIcon(2),								
				"Add a Shape Annotation",
				null);
		
		shapePalette.addShape(getControllingBoundedAnnotationAttribute(), "TextAnnotation",
                new CytoShapeIcon(3),								
				"Add a Bounded Annotation",
				null);
		
		shapePalette.addShape(getControllingImageAnnotationAttribute(), "TextAnnotation",
