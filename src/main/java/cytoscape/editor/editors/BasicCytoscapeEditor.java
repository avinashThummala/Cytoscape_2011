...
import cytoscape.editor.cyAnnotator.*;
...
public class BasicCytoscapeEditor implements CytoscapeEditor, SelectEventListener,
	...
	private String _controllingTextAnnotationAttribute="ANNOTATION_TEXT_TYPE";
	private String _controllingShapeAnnotationAttribute="ANNOTATION_SHAPE_TYPE";
	private String _controllingBoundedAnnotationAttribute="ANNOTATION_BOUNDED_TYPE";
	private String _controllingImageAnnotationAttribute="ANNOTATION_IMAGE_TYPE";
	
		
	private CyAnnotator cyAnnotator;
	
	private cTextAnnotation createTextAnnotation;
	private cShapeAnnotation createShapeAnnotation;
	private cBoundedAnnotation createBoundedAnnotation;
	private cImageAnnotation createImageAnnotation;
	...
	public BasicCytoscapeEditor() {
		...
		cyAnnotator=new CyAnnotator();
								
        createTextAnnotation=new cTextAnnotation();        
        createTextAnnotation.setSize(474, 504);		
        createTextAnnotation.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);		
        
        createShapeAnnotation=new cShapeAnnotation(cyAnnotator);        
        createShapeAnnotation.setSize(474, 504);		
        createShapeAnnotation.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        
        createBoundedAnnotation=new cBoundedAnnotation();        
        createBoundedAnnotation.setSize(482, 504);		
        createBoundedAnnotation.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);        
        
        createImageAnnotation=new cImageAnnotation();        
        createImageAnnotation.setSize(474, 445);		
        createImageAnnotation.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);        
	}
	...
	public void addTextAnnotation(String attribute, String value, Point2D location) {

		createTextAnnotation.setLocation((int)location.getX(),(int)location.getY());		
        createTextAnnotation.setVisible(true);		
						
		if( ((DingNetworkView)Cytoscape.getCurrentNetworkView()).getCanvas(DGraphView.Canvas.FOREGROUND_CANVAS).getMouseListeners().length == 0)
			cyAnnotator.initListeners();
	}
	
	public void addShapeAnnotation(String attribute, String value, Point2D location) {

		createShapeAnnotation.setLocation((int)location.getX(),(int)location.getY());		
        createShapeAnnotation.setVisible(true);		
						
		if( ((DingNetworkView)Cytoscape.getCurrentNetworkView()).getCanvas(DGraphView.Canvas.FOREGROUND_CANVAS).getMouseListeners().length == 0)
			cyAnnotator.initListeners();
	}
	
	public void addBoundedAnnotation(String attribute, String value, Point2D location) {

		createBoundedAnnotation.setLocation((int)location.getX(),(int)location.getY());		
        createBoundedAnnotation.setVisible(true);		
						
		if( ((DingNetworkView)Cytoscape.getCurrentNetworkView()).getCanvas(DGraphView.Canvas.FOREGROUND_CANVAS).getMouseListeners().length == 0)
			cyAnnotator.initListeners();
	}
	
	public void addImageAnnotation(String attribute, String value, Point2D location) {

		createImageAnnotation.setLocation((int)location.getX(),(int)location.getY());		
        createImageAnnotation.setVisible(true);		
...
//		}
	...
	public void setControllingTextAnnotationAttribute(String controllingAttribute) {
		_controllingTextAnnotationAttribute = controllingAttribute;
	}

	
	public String getControllingTextAnnotationAttribute() {
		return _controllingTextAnnotationAttribute;
	}
	
	public void setControllingShapeAnnotationAttribute(String controllingAttribute) {
		_controllingShapeAnnotationAttribute = controllingAttribute;
	}

	
	public String getControllingShapeAnnotationAttribute() {
		return _controllingShapeAnnotationAttribute;
	}
	
	public void setControllingBoundedAnnotationAttribute(String controllingAttribute) {
		_controllingBoundedAnnotationAttribute = controllingAttribute;
	}

	
	public String getControllingBoundedAnnotationAttribute() {
		return _controllingBoundedAnnotationAttribute;
	}		
	
	public void setControllingImageAnnotationAttribute(String controllingAttribute) {
		_controllingImageAnnotationAttribute = controllingAttribute;
	}

	
	public String getControllingImageAnnotationAttribute() {
		return _controllingImageAnnotationAttribute;
	}		
